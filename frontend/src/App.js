      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-black/30 backdrop-blur-sm rounded-xl p-8 border border-gray-700">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  placeholder="e.g., 'Top Three Creepiest Mysteries In Florida'"
            ...
            {/* Progress Display */}
            {currentStep && (
              <div className="bg-blue-900/30 backdrop-blur-sm rounded-xl p-6 border border-blue-700">
                <div className="text-center">
          ...
          {/* Right Column - Quick Downloads & Generated Content */}
          <div className="space-y-6">
            {/* Quick Downloads */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className={`bg-black/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700 ${generatedContent.script ? '' : 'opacity-50'}`}>
                ...
                {generatedContent.script ? (
                  <>
                    <p className="text-green-300 text-sm mb-2">{generatedContent.script.word_count} words</p>
                    <p className="text-green-200 text-xs">✓ Good length</p>
                  </>
                ) : (
                  <p className="text-gray-400 text-sm">Waiting for generation...</p>
                )}
              </div>
              ...
              <div className={`bg-black/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700 ${generatedContent.audio ? '' : 'opacity-50'}`}>
                ...
                {generatedContent.audio ? (
                  <>
                    <p className="text-green-300 text-sm mb-2">ElevenLabs AI</p>
                    <p className="text-green-200 text-xs">Click for MP3</p>
                  </>
                ) : (
                  <p className="text-gray-400 text-sm">Waiting for script...</p>
                )}
              </div>
              ...
              <div className={`bg-black/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700 ${generatedContent.thumbnail ? '' : 'opacity-50'}`}>
                ...
                {generatedContent.thumbnail ? (
                  <>
                    ...
                    <p className="text-green-300 text-sm mb-2">DALL-E 3</p>
                    <p className="text-green-200 text-xs">Click for PNG</p>
                  </>
                ) : (
                  <p className="text-gray-400 text-sm">Waiting for generation...</p>
                )}
              ...
              <div className={`bg-black/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700 ${generatedContent.videos ? '' : 'opacity-50'}`}>
                ...
                {generatedContent.videos ? (
                  <>
                    <p className="text-green-300 text-sm mb-2">{generatedContent.videos.total_found} clips</p>
                    <p className="text-green-200 text-xs">HD quality stock footage</p>
                  </>
                ) : (
                  <p className="text-gray-400 text-sm">Waiting for generation...</p>
                )}
